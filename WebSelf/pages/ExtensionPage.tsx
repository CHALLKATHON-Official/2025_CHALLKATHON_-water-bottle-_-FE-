  ...
  return (
    <div className="flex flex-col relative">
      ...
      <section className="relative">
        ...
        <div>
        <h2 className="text-3xl font-semibold text-center text-gray-800 tracking-tight leading-snug mb-4 fade-in-on-scroll" style={{fontFamily: `'Bungee', sans-serif`,}}>
          " 어떤 사이트를 가장 많이 방문했을까? "
        </h2>
        </div>
        ...
        <div className="mb-100 mt-3 fade-in-on-scroll">
          <PerDayGraphChart userId={userId} period="7days" />
        </div>
        <h2 className="text-3xl font-semibold text-center text-gray-800 tracking-tight leading-snug mb-4 fade-in-on-scroll" style={{fontFamily: `'Bungee', sans-serif`,}}>
          " 하루 중 내가 가장 바쁜 시간은? "
        </h2>
        <div className="mb-50 mt-3 fade-in-on-scroll">
