  ...
  return (
    <div className="relative">
      ...
      <section className="min-h-screen h-auto pt-[30vh] px-8 py-5">
        <GlobalSearchIntro />
        {/* top site bubble 그래프 */}
        <h1 className="text-3xl font-semibold text-center text-gray-800 tracking-tight leading-snug mb-4">전 세계에서 가장 핫한 사이트가 무엇일까요?</h1>
        <div className="mb-100 mt-5 fade-in-on-scroll">
          <GlobalTop8BubbleChart />
        </div>
        {/* 전체 사이트 원 그래프 */}
        <h1 className="text-3xl font-semibold text-center text-gray-800 tracking-tight leading-snug mb-4">전 세계 사람들은 어떤 사이트를 가장 많이 쓸까?</h1>
        <div className="mb-100 mt-5 fade-in-on-scroll">
          <GlobalUsagePieChart />
        </div>
        {/* 유형별 원 그래프 */}
        <h1 className="text-3xl font-semibold text-center text-gray-800 tracking-tight leading-snug mb-4">다른 사람들이 좋아하는 유형을 확인해보아요!</h1>
        <div className="mb-100 mt-5 fade-in-on-scroll">
